      ...
      <div className="relative h-screen w-full overflow-hidden pt-24">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-10">
          ...
          <motion.p
            ...
            className="mt-6 text-2xl text-white/80 max-w-2xl font-light"
          >
            Où la cuisine authentique rencontre l'art de recevoir.
          </motion.p>
          ...
          <motion.button
            ...
            className="mt-10 px-8 py-4 bg-white/20 border border-white/30 
             ...
             hover:bg-white/30 transition shadow-xl font-medium"
          >
            Réserver une table
          </motion.button>
        </div>
